...
void ButtonInit(void)
{
    ...
    //commenting out timer configuration because TI-RTOS configures on its own
...
//    TimerEnable(TIMER0_BASE, TIMER_BOTH);
    ...
    //commenting out because interrupt controller setup code
...
//adding booster button 2
    ...
    // ADC clock
    //commenting out because TI_RTOS configures clock generator on its own
...
//    IntEnable(INT_ADC1SS0); // enable ADC1 sequence 0 interrupt in int. controller
    ...
    //Timer ADC1
    //TI-RTOS configures its own timers
