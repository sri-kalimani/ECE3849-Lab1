...
void WaveformTask(UArg arg1, UArg arg2) //high priority
{
    //pend on the button Mailbox (blocking call). When it
    //receives a button ID, it should modify the oscilloscope
    //settings and signal the Display Task (using a Semaphore)
...
void UserInputTask(UArg arg1, UArg arg2) //medium priority
{
    IntMasterEnable();
